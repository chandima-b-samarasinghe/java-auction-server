...
public class StockCsv{
	...
	private ConcurrentHashMap<String,StockItem> data=null;
	...
	public StockCsv(String filename){
        ...
        data=new ConcurrentHashMap<String,StockItem>();
        ...
        try{
            ...
            while((currentRecord=br.readLine())!=null){
                ...
                double price;
                try{
                    price=Double.valueOf(arr_currentRecord[header_index[2]]);
                }catch(Exception ex){
                    price=0;
                }
	...
	public ConcurrentHashMap<String,StockItem> getData(){
		return this.data;
	}
    ...
    public void writeFile(ConcurrentHashMap<String,StockItem> data) throws IOException{
        fileAppend=new FileAppend(filename);
        fileAppend.clearFile();
        fileAppend.writeLine();//writing headers
